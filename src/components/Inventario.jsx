...
export function Inventario() {
    ...
    const cantidadExtraRef = useRef();
    const cantidadCorrienteRef = useRef();

    const updateCantidad = (tipo) => {

        const cantidad = cantidadExtraRef.current.value || cantidadCorrienteRef.current.value;
        ...
        .then((data) => {
            if (data.msg) {
                ...
                cantidadCorrienteRef.current.value = null;
                cantidadExtraRef.current.value = null;
                    ...
                    <Col style={{marginLeft:"350px"}} >
                        <Container id="Cont-Stock">
                            ...
                            <div id="SubContain-Stock2">
                                <div id="Text1-Style">Galones <br/> en pee</div>
                                <FormControl ref={cantidadCorrienteRef} id="StockInput"/>
                            </div>
                            <Button onClick={() => updateCantidad('corriente')} id="Boton" style={{margin:"10px 90px"}} as="input" type="submit" value="Agregar" />{' '}
                        </Container>
                        <Container id="Cont-Stock" style={{marginBottom:"70px"}}>
                            ...
                            <div id="SubContain-Stock2">
                                ...
                                <FormControl ref={cantidadExtraRef} id="StockInput"/>
                            </div>
                            <Button onClick={() => updateCantidad('extra')} id="Boton" style={{margin:"10px 90px"}} as="input" type="submit" value="Agregar" />{' '}
                        </Container>
                    </Col>
                    <Col md="auto">
